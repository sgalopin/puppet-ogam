...
1. [Setup - The basics of getting started with ogam](#setup)
    * [What ogam affects](#what-ogam-affects)
    * [Setup requirements](#setup-requirements)
    * [Beginning with ogam](#beginning-with-ogam)
