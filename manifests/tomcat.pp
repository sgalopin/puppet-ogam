class ogam::tomcat (
    ...
    file { "${tmp_directory}/ogam_upload":
        ensure  => directory,
        owner => 'tomcat8',
        group => 'tomcat8',
        mode    => '774',
    ...
    # }->
    # file { "${tomcat_directory}/conf/Catalina/localhost/OGAMIntegrationService.xml":
    #   ensure => 'file',
    #   source => "${git_clone_directory}/service_integration/config/OGAMIntegrationService.xml",
    # }->
